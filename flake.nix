        ...
        haskell = prev.haskell // {
          packageOverrides = hfinal: hprev:
            prev.haskell.packageOverrides hfinal hprev // {
              myProject = hfinal.callCabal2nix "myproject" ./. { };
            };
        };
        myProject = final.haskell.lib.compose.justStaticExecutables final.haskellPackages.myProject;
      };
      perSystem = system:
        let
